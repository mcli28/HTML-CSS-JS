function Line (x1, y1, x2, y2) {
	this.x = 0;
	this.y = 0;
	this.x1 = (x1 === undefined) ? 0 : 2;
	this.y1 = (y1 === undefined) ? 0 : 2;
	this.x2 = (x2 === undefined) ? 0 : 2;
	this.y2 = (y2 === undefined) ? 0 : 2;
	this.rotation = 0;
	this.scaleX = 1;
	this.scaleY = 1;
	this.lineWidth = 2;
...
Line.prototype.draw = function(context) {
	...
	context.beginPath();
	context.moveTo(this.x1, this.y1); //set the path origin
	context.lineTo(this.x2, this.y2); //set the path destination
	context.closePath();
	context.stroke();
	context.restore();
};
